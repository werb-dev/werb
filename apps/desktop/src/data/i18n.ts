...
const STRINGS: Record<string, Entry> = {
  ...
  "nav.inventory": { en: "Stock", fr: "Stock" },
  "nav.settings": { en: "Settings", fr: "Réglages" },
  "nav.tokens": { en: "Tokens", fr: "Tokens" },

  // Inventory / personal stock
  "inventory.title": { en: "Stock", fr: "Stock" },
  "inventory.intro": {
    en: "Track what you actually own. Set the real numbers for your stock — hop alpha %, malt EBC and yield, yeast attenuation — and recipes that use that ingredient by name pick them up automatically. The shared catalog stays untouched.",
    fr: "Suivez ce que vous possédez vraiment. Renseignez les vraies valeurs de votre stock — alpha % du houblon, EBC et rendement du malt, atténuation de la levure — et les recettes utilisant cet ingrédient par son nom les reprennent automatiquement. Le catalogue partagé reste intact.",
  },
  "inventory.subtitle_loading": { en: "Loading your stock…", fr: "Chargement de votre stock…" },
  "inventory.subtitle_count": { en: "{count} in stock", fr: "{count} en stock" },
  "inventory.add_title": { en: "Add to stock", fr: "Ajouter au stock" },
  "inventory.add": { en: "Add", fr: "Ajouter" },
  "inventory.remove": { en: "Remove", fr: "Retirer" },
  "inventory.empty": {
    en: "Nothing in stock yet. Add the malts, hops, and yeast you keep on hand.",
    fr: "Stock vide. Ajoutez les malts, houblons et levures que vous gardez sous la main.",
  },
  "inventory.name_placeholder": { en: "e.g. Cascade", fr: "ex. Cascade" },
  "inventory.category.fermentable": { en: "Malts & fermentables", fr: "Malts et fermentescibles" },
  "inventory.category.hop": { en: "Hops", fr: "Houblons" },
  "inventory.category.culture": { en: "Yeast & cultures", fr: "Levures et cultures" },
  "inventory.category.misc": { en: "Miscellaneous", fr: "Divers" },
  "inventory.field.category": { en: "Type", fr: "Type" },
  "inventory.field.name": { en: "Name", fr: "Nom" },
  "inventory.field.alpha": { en: "Alpha acid", fr: "Acide alpha" },
  "inventory.field.year": { en: "Year", fr: "Année" },
  "inventory.field.form": { en: "Form", fr: "Forme" },
  "inventory.field.color": { en: "Color", fr: "Couleur" },
  "inventory.field.yield": { en: "Yield", fr: "Rendement" },
  "inventory.field.attenuation": { en: "Attenuation", fr: "Atténuation" },
  "inventory.field.viability": { en: "Best by", fr: "À utiliser avant" },
  "inventory.field.quantity": { en: "On hand", fr: "Quantité" },
  "inventory.field.quantity_unit": { en: "Unit", fr: "Unité" },
  "inventory.field.notes": { en: "Notes", fr: "Notes" },
  "recipe.inventory.banner_title": {
  ...
  "recipe.inventory.field.attenuation": { en: "attenuation", fr: "atténuation" },
